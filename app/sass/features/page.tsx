...
const Section = () => {
    ...
    return (
        <div ref={ref} className="h-[100vh] w-[100vw]">
            ...
            <motion.div
                className="bg-blue-600 w-[200vh] relative h-5 z-30 origin-left"
...
export default function Page() {
    ...
    return (
        <div className="flex flex-col min-h-[100dvh]" ref={ref}>
            <HeaderSass />
            <motion.div
                className="bg-red-600 h-[100vh] w-5 fixed top-0 left-0 origin-top bg-blend-exclusion"
            ...
            <section className="w-full py-12 md:py-24 lg:py-32 xl:py-40">
                <motion.div
                    className="bg-green-600 relative w-[20vh] h-5 top-0 left-0 origin-left bg-blend-exclusion"
                    style={{ scaleX: scrollYProgress }}
                ></motion.div>
                <div className="container px-4 md:px-6 space-y-10 xl:space-y-16">
                    <div className="grid max-w-[1300px] mx-auto gap-4 px-4 sm:px-6 md:px-10 md:grid-cols-2 md:gap-16">
