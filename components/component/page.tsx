...
* @see https://v0.dev/t/OCuJTnK50bu
                  ...
                  <div className="grid gap-4">
                    ...
                    <div className="flex items-start gap-4">
                      ...
                      <div>
                        ...
                        <div className="mt-2">
                          <Textarea
                            className="w-full rounded-md border border-gray-200 border-gray-300 p-2 focus:outline-none focus:ring-2 focus:ring-[#2C7A7B] dark:border-gray-600 dark:bg-gray-700 dark:text-white dark:border-gray-800"
